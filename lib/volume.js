...
function dataToBuffer(data, encoding) {
  ...
  else if (data instanceof Uint8Array) return buffer_1.Buffer.from(data);
  else return buffer_1.Buffer.from(String(data), encoding);
}
...
var Volume = /** @class */ (function() {
  ...
  Volume.prototype.openLink = function(link, flagsNum, resolveSymlinks) {
    ...
    if (node.isDirectory()) {
      ...
      var isDir = (flagsNum & constants_1.constants.O_DIRECTORY) !== 0;
      if (!isRead && !isDir) {
